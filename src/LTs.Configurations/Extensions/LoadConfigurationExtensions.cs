...
public static class LoadConfigurationExtensions
{
    ...
    public static IConfigurationBuilder AddDefaultConfigurationForAssembly<T>( this IConfigurationBuilder builder,
        ...
        where T : class
        => builder.AddDefaultConfigurationForAssembly( typeof( T ), additionalConfigurationAction );

    /// <summary>
    ///     Add the default configuration for the assembly containing the type <paramref name="referenceType" />.
    ///     <para>
    ///         Loads the configuration in the following order:
    ///         <list type="bullet">
    ///             <item>appsettings.json</item>
    ...
    /// </summary>
    /// <param name="builder">The configuration builder.</param>
    /// <param name="referenceType">Type to get the assembly from.</param>
    /// <param name="additionalConfigurationAction">Additional configuration action.</param>
    /// <returns>The configuration builder with the added configurations.</returns>
    [ UsedImplicitly ]
    public static IConfigurationBuilder AddDefaultConfigurationForAssembly( this IConfigurationBuilder builder,
                                                                            Type referenceType,
                                                                            Action<IConfigurationBuilder>? additionalConfigurationAction )
    {
        ...
        builder
            ...
            .AddUserSecrets( assembly, true, false )
