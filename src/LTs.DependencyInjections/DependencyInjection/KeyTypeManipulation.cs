...
internal class KeyTypeManipulation
{
    ...
    ///     The destination <see cref="Type" /> to which <paramref name="value" /> should be
    ///     converted.
    /// </param>
    ...
    ///     converted.
    /// </param>
    /// <param name="converterAttribute">
    ///     A <see cref="TypeConverterAttribute" />, if available, specifying the type of
    ///     converter to use.<paramref name="value" /> is being converted.
    /// </param>
    /// <returns>
    ///     An <see cref="object" /> of type <paramref name="destinationType" />, converted using
